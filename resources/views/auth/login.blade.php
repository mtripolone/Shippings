...
@section('content')
  <div style="margin-left: auto; margin-right: auto; margin-top: 40px; max-width: 700px;">
    <main class="form-signin w-100 m-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center">Email: <strong>admin@material.com</strong> {{ __(' and the password ') }}<strong>secret</strong> </p>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg" style="color: white;">{{ __('Lets Go') }}</button>
          </div>
        </div>
      </form>
    </main>
...
{{--      <h3>Efetue o login abaixo e obtenha o máximo do sistema Trans Uello </h3>--}}
{{--    </div>--}}
